object frmPrincipal: TfrmPrincipal
  Left = 0
  Top = 0
  Caption = 'Transacoes com Cart'#245'es de Cr'#233'dito e D'#233'bito'
  ClientHeight = 505
  ClientWidth = 1108
  Color = clBtnFace
  ...
  object Page: TcxPageControl
    ...
    ClientRectTop = 24
    object TabTransacao: TcxTabSheet
      ...
      object Panel2: TPanel
        ...
        object chkForecast: TcxCheckBox
          Left = 268
          Top = 14
          Caption = 'Forecast'
          TabOrder = 0
    ...
    object TabDetalhe: TcxTabSheet
      ...
      object cxGridDet: TcxGrid
        ...
        ParentFont = False
        TabOrder = 1
        object cxGridDetDBTableView1: TcxGridDBTableView
          Navigator.Buttons.CustomButtons = <>
          OnCellDblClick = cxGridDetDBTableView1CellDblClick
          DataController.DataSource = dsDetalhe
          DataController.Summary.DefaultGroupSummaryItems = <
            item
              Kind = skSum
              FieldName = 'Valor'
              Column = cxGridDetDBTableView1Valor
          ...
          OptionsData.Inserting = False
          OptionsView.Indicator = True
          object cxGridDetDBTableView1Favorecido: TcxGridDBColumn
            DataBinding.FieldName = 'Favorecido'
            GroupIndex = 2
            Width = 200
          end
          object cxGridDetDBTableView1Categoria: TcxGridDBColumn
            DataBinding.FieldName = 'Categoria'
            Width = 150
          end
          object cxGridDetDBTableView1SubCategoria: TcxGridDBColumn
            DataBinding.FieldName = 'SubCategoria'
            Width = 150
          end
          object cxGridDetDBTableView1DataTransacao: TcxGridDBColumn
            DataBinding.FieldName = 'DataTransacao'
            Width = 100
          end
          object cxGridDetDBTableView1mes: TcxGridDBColumn
            DataBinding.FieldName = 'mes'
            Visible = False
            GroupIndex = 1
          end
          object cxGridDetDBTableView1ano: TcxGridDBColumn
            DataBinding.FieldName = 'ano'
            Visible = False
            GroupIndex = 0
          end
          object cxGridDetDBTableView1Valor: TcxGridDBColumn
            DataBinding.FieldName = 'Valor'
          end
        end
        object cxGridDetLevel1: TcxGridLevel
          GridView = cxGridDetDBTableView1
        end
      end
    end
          ...
          object Panel5: TPanel
            ...
            object DBChart1: TDBChart
              ...
              object Series2: TPieSeries
                Marks.Visible = True
                DataSource = sqlGrafico1
                XLabelsSource = 'LEGENDA'
            ...
            object cxGrid2: TcxGrid
              ...
              object cxGrid2DBTableView1: TcxGridDBTableView
                ...
                OptionsView.Indicator = True
                object cxGrid2DBTableView1Favorecido: TcxGridDBColumn
                  Caption = 'Company'
                  DataBinding.FieldName = 'Favorecido'
                  Width = 150
                end
                object cxGrid2DBTableView1Unnamed2: TcxGridDBColumn
                  Caption = 'Category'
                  DataBinding.FieldName = 'Categoria'
                  Width = 150
                end
                object cxGrid2DBTableView1datatransacao: TcxGridDBColumn
                  Caption = 'Date'
                  DataBinding.FieldName = 'datatransacao'
                  Width = 80
                end
        ...
        object cxTabSheet3: TcxTabSheet
          ...
          object DBChart3: TDBChart
            ...
            object Series3: TBarSeries
              ColorEachPoint = True
              Marks.Visible = True
              DataSource = sqlGraficoWeek
              XLabelsSource = 'CENTRODECUSTO'
              XValues.Name = 'X'
              XValues.Order = loAscending
              XValues.ValueSource = 'WEEK'
              YValues.Name = 'Bar'
              YValues.Order = loNone
              YValues.ValueSource = 'VALOR'
            end
    ...
    object TabIE: TcxTabSheet
      ...
      object cxGridTMAQ_ApontamentoGrafico01: TcxGrid
        ...
        object cxTableViewSEMANA: TcxGridDBChartView
          Categories.DataBinding.FieldName = 'TIQF_PERDAT'
          Categories.OnGetValueDisplayText = cxTableViewSEMANACategoriesGetValueDisplayText
          DataController.DataSource = dsGrafIE
          DataController.KeyFieldNames = 'SEMANA'
          ...
          object cxTableViewSEMANADataGroup1: TcxGridDBChartDataGroup
  ...
  object dsTransacao: TDataSource
    DataSet = cdsTransacao
    Left = 464
    Top = 248
  end
  object cdsTransacao: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspTransacao'
    Left = 384
    Top = 248
    object cdsTransacaoId: TAutoIncField
      FieldName = 'Id'
      ReadOnly = True
    end
    object cdsTransacaoTipo: TStringField
      FieldName = 'Tipo'
      Size = 10
    end
    object cdsTransacaoDataTransacao: TDateField
      FieldName = 'DataTransacao'
    end
    object cdsTransacaoFavorecido: TStringField
      FieldName = 'Favorecido'
      Size = 100
    end
    object cdsTransacaoCategoria: TStringField
      FieldName = 'Categoria'
      Size = 50
    end
    object cdsTransacaoSubCategoria: TStringField
      FieldName = 'SubCategoria'
      Size = 30
    end
    object cdsTransacaoValor: TBCDField
      FieldName = 'Valor'
      Precision = 15
      Size = 2
    end
    object cdsTransacaoDataCriacao: TSQLTimeStampField
      FieldName = 'DataCriacao'
    end
    object cdsTransacaoConta: TStringField
      FieldName = 'Conta'
      Size = 30
    end
    object cdsTransacaoCENTRODECUSTO: TStringField
      FieldName = 'CENTRODECUSTO'
      Size = 40
    end
    object cdsTransacaoID_USER: TIntegerField
      FieldName = 'ID_USER'
    end
  end
  object dspTransacao: TDataSetProvider
    DataSet = sqlTransacao
    Options = [poAllowCommandText, poUseQuoteChar]
    Left = 304
    Top = 248
  end
  object sqlTransacao: TFDQuery
    Connection = Dados.FDConnection
    SQL.Strings = (
      'select * from dbo.tbtransacao')
    Left = 228
    Top = 248
  end
  object sqlDetalhe: TFDQuery
    ...
    object sqlDetalheFavorecido: TStringField
      FieldName = 'Favorecido'
      Origin = 'Favorecido'
      Size = 100
    end
    object sqlDetalheCategoria: TStringField
      FieldName = 'Categoria'
      Origin = 'Categoria'
      Size = 50
    end
    object sqlDetalheSubCategoria: TStringField
      FieldName = 'SubCategoria'
      Origin = 'SubCategoria'
      Size = 30
    end
    object sqlDetalheDataTransacao: TDateField
      FieldName = 'DataTransacao'
  ...
  object MainMenu1: TMainMenu
    ...
    object File1: TMenuItem
      ...
      object CostCenter1: TMenuItem
        Caption = 'Cost Center'
        OnClick = CostCenter1Click
      end
      object N2: TMenuItem
        Caption = '-'
      end
  ...
  object sqlGrafico1: TFDQuery
    ...
    SQL.Strings = (
      ...
      'WHERE DATATRANSACAO BETWEEN '#39'2022-01-01 '#39' AND '#39'2022-01-31'#39
        ...
        'AND ID_USER = 1 AND CENTRODECUSTO IS NOT NULL  AND TIPO = '#39'EXPEN' +
        'SE'#39
      ''
      'UNION ALL   '
      ...
      'AND ID_USER = 1'
        ...
        'AND CENTRODECUSTO = '#39'FUEL'#39' AND CENTRODECUSTO IS NOT NULL  AND TI' +
        'PO = '#39'EXPENSE'#39)
    Left = 76
    Top = 320
  ...
  object sqlCentroCusto: TFDQuery
    Connection = Dados.FDConnection
    SQL.Strings = (
      'WITH DADOS (ID_CENTRODECUSTO, CENTRODECUSTO)  AS'
      '('
      
        #9'SELECT TOP 1 -1 as ID_CENTRODECUSTO , '#39'ALL COST CENTER'#39' as CENT' +
        'RODECUSTO FROM CENTRODECUSTO WHERE 1 = 1'
      #9'UNION ALL'
      
        #9'SELECT ID_CENTRODECUSTO, CENTRODECUSTO  FROM CENTRODECUSTO WHER' +
        'E ID_USER = 1 AND ID_LANGUAGE = 1'
      ') '
      'SELECT * FROM DADOS ORder by ID_CENTRODECUSTO, CENTRODECUSTO')
    Left = 212
    Top = 320
    object sqlCentroCustoID_CENTRODECUSTO: TIntegerField
  ...
  object sqlGraficoBarra: TFDQuery
    Connection = Dados.FDConnection
    SQL.Strings = (
  ...
  object dsGraficoBarra: TDataSource
    DataSet = sqlGraficoBarra
    Left = 564
    Top = 320
  end
  ...
  object sqlGraficoWeek: TFDQuery
    Connection = Dados.FDConnection
    SQL.Strings = (
